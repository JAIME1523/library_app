...
//
//     final librayReponse = librayReponseFromJson(jsonString);

import 'dart:convert';

LibrayReponse librayReponseFromJson(String str) => LibrayReponse.fromJson(json.decode(str));

String librayReponseToJson(LibrayReponse data) => json.encode(data.toJson());
...
class LibrayReponse {
    ...
    final List<Doc> docs;
    final int librayReponseNumFound;
    final String q;
    ...
    LibrayReponse({
        ...
        required this.docs,
        required this.librayReponseNumFound,
        required this.q,
        required this.offset,
    });

    factory LibrayReponse.fromJson(Map<String, dynamic> json) => LibrayReponse(
        numFound: json["numFound"],
        start: json["start"],
        numFoundExact: json["numFoundExact"],
        docs: List<Doc>.from(json["docs"].map((x) => Doc.fromJson(x))),
        librayReponseNumFound: json["num_found"],
        q: json["q"],
        offset: json["offset"],
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "num_found": librayReponseNumFound,
        "q": q,
        "offset": offset,
    };
}
...
class Doc {
    ...
    factory Doc.fromJson(Map<String, dynamic> json) => Doc(
        ...
        idDoi: json["id_doi"] == null ? [] : List<String>.from(json["id_doi"]!.map((x) => x)),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "id_doi": idDoi == null ? [] : List<dynamic>.from(idDoi!.map((x) => x)),
